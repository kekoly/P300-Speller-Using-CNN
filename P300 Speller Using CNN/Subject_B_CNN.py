...
#Load Data
x_train = np.load('P300 Data/b_signal_train.npy')
x_test = np.load('P300 Data/b_signal_test.npy')
y_train = np.load('P300 Data/b_type_train.npy').astype(int)
y_test = np.load('P300 Data/b_type_test.npy').astype(int)
a_code_test = np.load('P300 Data/b_code_test.npy').astype(int)
...
keras.models.save_model(
    model = p300,
    filepath = 'Models/Subject_B_CNN.h5',
    overwrite = True,
